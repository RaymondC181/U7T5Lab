...
public class SearchTest {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println(Search.linearSearchInteger(numArrayList, 3));
        System.out.println(Search.linearSearchInteger(numArrayList, 9));
        System.out.println(Search.linearSearchInteger(numArrayList, -23));
        System.out.println(Search.linearSearchInteger(numArrayList, 99));

        System.out.println("Tests of linear search String array:");
        String[] arr1 = {"blue", "red", "purple", "green", "purple"};
        System.out.println(Search.linearSearchString(arr1, "purple"));
        System.out.println(Search.linearSearchString(arr1, "pink"));
        */
